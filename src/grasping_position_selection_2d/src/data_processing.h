...
Eigen::Vector2f feedback_pt, target_pt,
                ee_pt, ee_target_pt, ee_to_obs_obs_pt, 
                DO_to_obs_DO_pt, DO_to_obs_obs_pt,
...
std::string data_save_order_info = "Format: feedback_pt---target_pt---ee_pt---ee_to_obs_obs_pt"
                                    "---DO_to_obs_DO_pt---DO_to_obs_obs_pt---projection_on_path_pt---Jd";
...
public:
    ...
    void DetectViolation(const visual_module::visual_info_service_singlePt& srv) {
        ...
        obs_to_ee_vec(0, 0) = srv.response.ee_pt[0] - srv.response.ee_to_obs_obs_pt[0];
        obs_to_ee_vec(1, 0) = srv.response.ee_pt[1] - srv.response.ee_to_obs_obs_pt[1];
        std::cout << "obs_to_ee distance: " << obs_to_ee_vec.norm() << '\n';
        ...
        std::cout << "obs_to_DO distance: " << obs_to_DO_vec.norm() << '\n';
    ...
    Eigen::Vector3f GenerateAdjustmentVelocity() {
        ...
        gradient_projection /= gradient_projection.norm();
